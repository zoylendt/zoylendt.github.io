...
| ---------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------ | ----------------------------- |
| LinksHeader                                                      | [Notesko](https://notes.camargomau.com/) & [Morrowind Modding Wiki](https://morrowind-modding.github.io/)       | [GitHub](https://github.com/camargomau/notkesto-site) & [GitHub](https://github.com/morrowind-modding/morrowind-modding.github.io/)                                                                           | not anymore        | used too much space on mobile |
| Animated image (on mouseover)                                    | [Topo Damente](https://www.pmcf.xyz/topo-da-mente/)                                                             | [GitHub](https://github.com/search?q=repo%3Afreenandes%2Ftopo-da-mente%20gate%20svg&type=code)                                                                                                                | no                 | very complicated              |
...
| Site-specific git links below Publish Date                       | [yxy.ninja](https://notes.yxy.ninja/)                                                                           | [GitHub](https://github.com/xy-241/CS-Notes)                                                                                                                                                                  | yes                |                               |
| Dark Mode toggle in right column                                 |                                                                                                                 |                                                                                                                                                                                                               |                    |                               |
| Navbar (and mobile hamburger menu)                               | [The Pond](https://turntrout.com/design)                                                                        | [GitHub](https://github.com/search?q=repo%3Aalexander-turner%2FTurnTrout.com+navbar&type=code)                                                                                                                | no                 | -> many good parts            |
| Link to random page & scroll to top (footer)                     | [Morrowind Modding Wiki](https://morrowind-modding.github.io/) & [eilleeenz.com](https://quartz.eilleeenz.com/) | [GitHub](https://github.com/morrowind-modding/morrowind-modding.github.io/blob/main/quartz/components/Footer.tsx) & [GitHub](https://github.com/fanteastick/quartz-test/blob/v4/quartz/components/Footer.tsx) |                    |                               |
| Map icon next to search button                                   | [eilleeenz.com](https://quartz.eilleeenz.com/meta/Map)                                                          | [GitHub](https://github.com/fanteastick/quartz-test/)                                                                                                                                                         |                    | -> many good parts            |
| Custom image as blog title                                       | [Gatekeeper Wiki](https://www.gatekeeper.wiki/) & [eledah.ir](https://blog.eledah.ir/)                          | [GitHub](https://github.com/Mondrethos/gatekeeperwiki/blob/b2ef843cab9c39e137b1361e734dfb3474600f70/quartz/components/PageTitle.tsx#L10) & [GitHub](https://github.com/eledah/quartz_blog/)                   |                    |                               |
| Link blocks on start page                                        | [Gatekeeper Wiki](https://www.gatekeeper.wiki/)                                                                 | [GitHub](https://github.com/Mondrethos/gatekeeperwiki/blob/b2ef843cab9c39e137b1361e734dfb3474600f70/quartz/styles/custom.scss#L691)                                                                           |                    | mainly custom CSS             |
| Links in left page column                                        | [Ellie.wtf](https://ellie.wtf/)                                                                                 | [GitHub](https://github.com/ellie/notes/blob/v4/quartz.layout.ts)                                                                                                                                             |                    |                               |
| Graph view & Backlinks below central column                      | [be-far.com](https://be-far.com/)                                                                               | [GitHub](https://github.com/bfahrenfort/quartz)                                                                                                                                                               |                    |                               |
| (Mobile) Tags, backlinks, most recent & explorer under main page | [Topo Damente](https://www.pmcf.xyz/topo-da-mente/)                                                             | [GitHub](https://github.com/freenandes/topo-da-mente)                                                                                                                                                         |                    |                               |
| Search icon instead of text field                                | [Topo Damente](https://www.pmcf.xyz/topo-da-mente/)                                                             | [GitHub](https://github.com/freenandes/topo-da-mente)                                                                                                                                                         |                    |                               |
...
The original files and my custom changed files have I documented [[quartz my config|here]].
